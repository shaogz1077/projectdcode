package com.ytpdw.fun.viewtools.wheel;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        if (itemsLayout != null && itemsLayout.getChildAt(0) != null) {
            int width = itemsLayout.getChildAt(0).getWidth();
            canvas.drawText(timeStr, width / 1.5f, center, paint);
        }
    ...
    private boolean rebuildItems() {
        ...
        if (itemsLayout != null) {
            ...
            createItemsLayout();//��ʼ��LinearLayout
            updated = true;
        }
    ...
    public void setSettingText(String _timeStr) {
