...
public class AsyncHttpRequest implements Runnable {
    ...
    public void run() {
        ...
        responseHandler.sendStartMessage();//第三步，通过接口的方式通知启动请求数据方式
    ...
    private void makeRequest() throws IOException {//第五步
        if (isCancelled()) {
            return;
        }
