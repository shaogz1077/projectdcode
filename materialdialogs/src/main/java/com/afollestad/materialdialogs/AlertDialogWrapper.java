...
public class AlertDialogWrapper {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            builder = new com.afollestad.materialdialogs.MaterialDialog.Builder(context);
        }
        ...
        public Builder setAdapter(ListAdapter adapter, final DialogInterface.OnClickListener listener) {
            ...
            builder.listCallbackCustom = new com.afollestad.materialdialogs.MaterialDialog.ListCallback() {
                @Override
        ...
        private void addListCallbacks() {
            if (onClickListener != null) {
                builder.itemsCallback(new com.afollestad.materialdialogs.MaterialDialog.ListCallback() {
                    @Override
                    public void onSelection(com.afollestad.materialdialogs.MaterialDialog dialog, View itemView, int which, CharSequence text) {
        ...
        private void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems, final DialogInterface.OnMultiChoiceClickListener listener) {
            ...
            builder.itemsCallbackMultiChoice(selectedIndicesArr, new com.afollestad.materialdialogs.MaterialDialog.ListCallbackMultiChoice() {
                @Override
                public boolean onSelection(com.afollestad.materialdialogs.MaterialDialog dialog, Integer[] which, CharSequence[] text) {
        ...
        public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem, final DialogInterface.OnClickListener listener) {
            builder.items(items);
            builder.itemsCallbackSingleChoice(checkedItem, new com.afollestad.materialdialogs.MaterialDialog.ListCallbackSingleChoice() {
                @Override
