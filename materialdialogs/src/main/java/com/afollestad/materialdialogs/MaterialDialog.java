...
/*
    *//**
    ...
    public interface ListCallback {
        void onSelection(com.afollestad.materialdialogs.MaterialDialog dialog, View itemView, int which, CharSequence text);
    }
    ...
    public interface ListCallbackSingleChoice {
         ...
         */
        boolean onSelection(com.afollestad.materialdialogs.MaterialDialog dialog, View itemView, int which, CharSequence text);
    }
    ...
    public interface ListCallbackMultiChoice {
         ...
         */
        boolean onSelection(com.afollestad.materialdialogs.MaterialDialog dialog, Integer[] which, CharSequence[] text);
    }

    public interface InputCallback {

        void onInput(com.afollestad.materialdialogs.MaterialDialog dialog, CharSequence input);
    }
    ...
    public static class Builder {
        ...
        public com.afollestad.materialdialogs.MaterialDialog build() {
            return new com.afollestad.materialdialogs.MaterialDialog(this);
        }

        public com.afollestad.materialdialogs.MaterialDialog show() {
            com.afollestad.materialdialogs.MaterialDialog dialog = build();
            dialog.show();
            return dialog;
        }
    }
